...
class FakultasController extends Controller
{
    ...
    {   
        ...
        return redirect(route('fakultas.index'))->with('success','Berhasil menyimpan data prodi');
    }
    ...
    public function update(FakultasRequest $request, Fakultas $fakulta)
    {
        ...
        return redirect(route('fakultas.index'))->with('success', 'Berhasil update data prodi');
    }

    public function destroy(Fakultas $fakulta)
    {
        $fakulta->delete();
        return back()->with('success', 'Berhasil hapus data prodi');
    }
}
