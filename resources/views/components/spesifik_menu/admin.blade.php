...
<li class="dropdown{{ request()->routeIs('fakultas.index') ? ' active' : '' }}">
    <a href="{{ route('fakultas.index') }}" class="nav-link"><i
            data-feather="briefcase"></i><span>Prodi</span></a>
</li>
...
<li class="dropdown{{ request()->routeIs(['dosens.index','mahasiswa.index','admins.index']) ? ' active' : '' }}">
    ...
    <ul class="dropdown-menu">
        ...
        <li {{ request()->routeIs('admins.index') ? 'class=active' : '' }}><a class="nav-link"
