<div class="main-sidebar sidebar-style-2">
	<aside id="sidebar-wrapper">
		<div class="sidebar-brand">
			<a href="https://polimdo.ac.id/" target="_blank"> <img alt="image" src="/assets/images/logo/logo-elearning.png" style="width: 45px; height: 45px" class="header-logo" /></a>
				<h6><span class="logo-name"><b>E-Learning Teknik Elektro</b></span> </h6>
		</div>
