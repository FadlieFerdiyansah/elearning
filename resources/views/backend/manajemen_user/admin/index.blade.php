<x-app-layouts title="Users: Admin">
    @push('styles')
    {{-- dataTables --}}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4>Tabel Admin</h4>
                    <a href="{{ route('admins.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Tambah Admin</a>
                </div>
                <div class="card-body">
                    <x-alert />
                    ...
                    columns: [
                        ...
                        {data:'id', orderable: false, searchable: false,
                            "render": function(data,type,row) {
                                // console.log(row.id);
                                var html = "<input type='checkbox' name='id[]' class='chk_boxes1' value="+ data +">"
                                return html
                            } 
                        },
                    ]
        ...
        $(document).ready(function(){
            ...
            $('#btn_delete').click(function(){
                ...
                if(id.length === 0){
                    ...
                    $.ajax({ url:'{!! route('admins.index') !!}', type:'delete', data:{ "_token": "{{ csrf_token() }}", id:id } });
