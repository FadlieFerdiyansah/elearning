            ...
            <form action="{{ route('materis.update', encrypt($materi->id)) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control selectric" name="tipe" id="tipe">
                        ...
                        <option {{ $materi->tipe == 'pdf' ? 'selected' : '' }} value="pdf">File</option>
                ...
                <div class="form-group" id="formLink">
                    ...
                    <input type="text" name="file_or_link" class="form-control" id="link" value="{{ $materi->tipe == 'youtube' ? $materi->file_or_link : '' }}" placeholder="jfKfPfyJRdk">
                </div>
