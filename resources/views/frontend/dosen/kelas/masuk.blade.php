        ...
        <div class="card col-sm-12 col-lg-6 mx-1">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col mb-4 mb-lg-0 text-center">
                        <i data-feather="user-x" style="width: 100px; height: 40px"></i>
                        <div class="mt-2 font-weight-bold mb-1">Izin</div>
                        <h6 class="badge badge-warning">{{ $mahasiswaIzin }}</h6>
                    </div>
                    <div class="col mb-4 mb-lg-0 text-center">
                        <i data-feather="user-x" style="width: 100px; height: 40px"></i>
                                        ...
                                        <td>
                                            ...
                                            <div class="pretty p-default p-round p-thick">
                                                <input type="radio" name="status[]{{ $i }}" value="1" {{
                                                    $mhs->mahasiswaAbsenHariIni?->status == '1' ? 'checked' : '' }}>
                                            ...
                                            <div class="pretty p-default p-round p-thick">
                                                <input type="radio" name="status[]{{ $i }}" value="0" {{
                                                    $mhs->mahasiswaAbsenHariIniTidakHadir?->status == '0' || $mhs->mahasiswaAbsenHariIni?->status == '0' || $mhs->mahasiswaAbsenHariIni?->status == null ? 'checked' : '' }}>
                                            ...
                                            <div class="pretty p-default p-round p-thick">
                                                <input type="radio" name="status[]{{ $i }}" value="2" {{
                                                    $mhs->mahasiswaAbsenHariIniIzin?->status == '2' ? 'checked' : '' }}>
                                                <div class="state p-warning-o">
                                                    <label>Izin</label>
                                                </div>
                                            </div>
                                            <div class="pretty p-default p-round p-thick">
                                                <input type="radio" name="status[]{{ $i }}" value="3" {{
                                                    $mhs->mahasiswaAbsenHariIniSakit?->status == '3' ? 'checked' : '' }}>
                                                <div class="state p-secondary-o">
                                                    <label>Sakit</label>
                                                </div>
                                            </div>
                                        </td>
