        ...
        <div class="col-12 col-md-5">
            <div class="card">
                <div class="card-header">
                    <h6 class="text-muted">Info Dosen</h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="list-group">
                        <a  class="list-group-item list-group-item-action">
                            ...
                            <div class="d-flex justify-content-center">
                                <h6 class="mb-1">{{ Auth::user()->nip }}</h6>
                            </div>
                        </a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <form action="{{ route('dashboard.dosen_updateProfile') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <table class="table">
                                <tr>
